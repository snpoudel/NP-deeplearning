...
# Output path:    output/predictions/glofas_transformer/nepal_{gauge_id}_glofas_transformer.parquet
...
PRED_DIR = Path("output/predictions/glofas_transformer")
SCALER_PATH = MODEL_DIR / "scaler.pkl"
MODEL_PATH = MODEL_DIR / "glofas_transformer_best.pt"
...
def main() -> None:
    ...
    loss_path = MODEL_DIR / "glofas_transformer_loss_curves.parquet"
    ...
    qobs_val = val_df_orig["residual"].iloc[seq_len - 1:].values + qglofas_val
