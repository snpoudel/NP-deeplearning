# LSTM post-processor for correcting GRFR streamflow outputs.
#
# Identical to 03_run_glofas_lstm.py but uses GRFR instead of GloFAS.
# Approach (residual correction):
#   1. Compute residual = qobs - qgrfr for every timestep
#   2. Train the LSTM to predict this residual from ERA5 + static inputs
...
# Output path:    output/predictions/grfr_lstm/nepal_{gauge_id}_grfr_lstm.parquet
...
PRED_DIR = Path("output/predictions/grfr_lstm")
SCALER_PATH = MODEL_DIR / "scaler.pkl"
MODEL_PATH = MODEL_DIR / "grfr_lstm_best.pt"
...
def main() -> None:
    ...
    loss_path = MODEL_DIR / "grfr_lstm_loss_curves.parquet"
