...
# Output path:    output/predictions/grfr_transformer/nepal_{gauge_id}_grfr_transformer.parquet
...
PRED_DIR = Path("output/predictions/grfr_transformer")
SCALER_PATH = MODEL_DIR / "scaler.pkl"
MODEL_PATH = MODEL_DIR / "grfr_transformer_best.pt"
...
def main() -> None:
    ...
    loss_path = MODEL_DIR / "grfr_transformer_loss_curves.parquet"
